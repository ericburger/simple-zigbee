/* 
   Getting Started: Part 3a
   Coordinator Example 3
  
   This example will expand upon the Coordinator Example 2 sketch
   (Getting Started: Part 2a). In this example, the Arduino will
   process and respond to incoming packets. Also, the packet types
   will be identified using SimpleZigBeeRadio methods.
