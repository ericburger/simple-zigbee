/* 
   Getting Started: Part 3b
   Router Example 3
  
   This example will expand upon the Router Example 2 sketch.
   (Getting Started: Part 2b). In this example, the router
   will send several number usig a TX Request to the Coordinator.
   The Coordinator will sum the numbers and return the result.
   ...
   1. Complete "Getting Started: Part 3a".
    ...
    while( xbee.available() ){
      ...
      if( xbee.isComplete() ){
        ...
        if( xbee.isRX() ){
          ...
          // a TX Request containing an interger (2 bytes) in
